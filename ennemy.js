...
Ennemy.prototype.computeBoundingBox = function (vertices) {
    var i, j;
...
Ennemy.prototype.handleLoadedObject = function (objData) {
...
Ennemy.prototype.initParameters = function () {
    ...
    this.viewMatrix = mat4.lookAt([0, this.deepLookAt, 0], [0, 0, 2], [0, 0, -1]);
...
Ennemy.prototype.getBBox = function () {
    return [this.bbminP, this.bbmaxP];
}

Ennemy.prototype.getZ = function () {
...
Ennemy.prototype.load = function (filename) {
    var vertices = null;
